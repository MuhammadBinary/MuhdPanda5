...
object EmbeddingService {
    ...
    suspend fun generateEmbedding(
        ...
        while (attempts < maxRetries) {
            ...
            // Embedding requires a direct Google API key — not available in OpenRouter mode.
            // Return null gracefully so memory features degrade without crashing.
            if (currentApiKey.isBlank()) {
                Log.w("EmbeddingService", "No Gemini API key configured. Embedding skipped.")
                return null
            }
